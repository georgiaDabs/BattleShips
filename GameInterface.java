...
public interface GameInterface
{
     ...
     * This method should get ask players for ship placements. The board that is passed to the players when 
     * choosing placements should be a clone of the game board so that they can try out moves without affecting the state of the game.
